                        ...
                        <div>
                            ...
                            <div class="mt-1 flex flex-wrap gap-1">
                                @foreach ((array) $insiden->detailPasien->jenis_kesalahan as $jk)
                                    <span class="inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600">{{ $jk }}</span>
                                @endforeach
                            </div>
                        </div>
                    @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex flex-wrap gap-1">
                                @foreach ((array) $insiden->detailPasien->cedera as $c)
                                    <span class="inline-flex items-center rounded-full bg-red-50 px-2 py-0.5 text-xs font-medium text-red-600">{{ $c }}</span>
                                @endforeach
                            </div>
                        </div>
                    @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex flex-wrap gap-1">
                                @foreach ((array) $insiden->detailPasien->faktor_penyebab as $fp)
                                    <span class="inline-flex items-center rounded-full bg-amber-50 px-2 py-0.5 text-xs font-medium text-amber-700">{{ $fp }}</span>
                                @endforeach
                            </div>
                        </div>
                    @endif
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex flex-wrap gap-1">
                                @foreach ((array) $insiden->detailPasien->intervensi_pasien as $ip)
                                    <span class="inline-flex items-center rounded-full bg-blue-50 px-2 py-0.5 text-xs font-medium text-blue-600">{{ $ip }}</span>
                                @endforeach
                            </div>
                        </div>
                    @endif
