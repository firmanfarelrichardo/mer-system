                        ...
                        <tr class="transition-colors hover:bg-slate-50/60">
                            ...
                            <td class="whitespace-nowrap px-4 py-3.5 sm:px-5">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form method="POST" action="{{ route('laporan.draf.hapus', $draf->id) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus draf laporan ini secara permanen?');" class="inline-block">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                title="Hapus Draf"
                                                class="inline-flex items-center gap-1.5 rounded-lg bg-rose-50 px-3 py-1.5
                                                       text-xs font-semibold text-rose-600 shadow-sm ring-1 ring-inset ring-rose-200 
