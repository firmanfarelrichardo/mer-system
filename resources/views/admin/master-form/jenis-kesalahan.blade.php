    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-400">
                Kelola daftar jenis kesalahan obat untuk formulir pelaporan insiden.
            </p>
        </div>
                                ...
                                <td class="px-5 py-3 text-center">
                                    <div class="flex items-center justify-center gap-1">
                                        ...
                                        <form method="POST" action="{{ route('admin.jenis-kesalahan.hapus', $item->id) }}"
                                              onsubmit="return confirm('Hapus jenis kesalahan {{ addslashes($item->nama) }}? Aksi ini tidak dapat dibatalkan.')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                    title="Hapus"
