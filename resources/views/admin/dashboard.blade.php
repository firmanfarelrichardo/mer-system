...
@section('konten')
    ...
    <div class="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <a href="{{ route('admin.pengguna.buat') }}"
           class="group flex items-start gap-4 rounded-xl border border-slate-200 bg-white p-5
                  shadow-sm transition-shadow hover:shadow-md">
            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg
                        bg-brand/10 text-brand transition-colors group-hover:bg-brand group-hover:text-white">
            ...
            <div>
                <p class="text-sm font-semibold text-slate-800 group-hover:text-brand">Tambah Pengguna</p>
                <p class="mt-0.5 text-xs text-slate-400">Registrasi akun baru ke sistem</p>
            </div>
        </a>
        ...
        <a href="{{ route('admin.pengguna.index') }}"
           class="group flex items-start gap-4 rounded-xl border border-slate-200 bg-white p-5
            ...
            <div>
                <p class="text-sm font-semibold text-slate-800 group-hover:text-brand">Daftar Pengguna</p>
                <p class="mt-0.5 text-xs text-slate-400">Kelola & filter semua akun pengguna</p>
            </div>
        </a>

        {{-- Log Aktivitas (Coming Soon) --}}
        <div class="group flex items-start gap-4 rounded-xl border border-dashed border-slate-300 bg-slate-50 p-5 opacity-60">
            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-slate-200 text-slate-400">
                <svg class="h-5 w-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div>
                <p class="text-sm font-semibold text-slate-500">Log Aktivitas</p>
                <p class="mt-0.5 text-xs text-slate-400">Segera tersedia</p>
            </div>
        </div>
    </div>
